...
Reguły (ustalone z właścicielem):
  • Parter (R1) i Góra (R1)  — sprzątane CODZIENNIE (tam codziennie siedzą goście),
  • Zielona                  — w każdą NIEDZIELĘ,
  • po imprezie              — sala sprzątana NASTĘPNEGO dnia; mapowanie kodów sal
                               z plików imprez: R2P→Zielona, R2Piw→Lustrzana, R2G→Kryształowa.
                               Impreza na R1 nie dodaje wpisu (R1 i tak codziennie).
