// Spójny zestaw ikon wektorowych (jeden styl: outline, stroke 2, zaokrąglone).
// Zastępuje ikony emoji oraz słownik ICONS z poprzedniej aplikacji.
...
const PATHS = {
  ...
  megaphone: [
    'M3 11v2a2 2 0 002 2h3l4 4V5L8 9H5a2 2 0 00-2 2z',
    'M16 8a5 5 0 010 8M18 6a8 8 0 010 12',
  ],
  warning: [
